...
import "./ToDoList.css";
import { FaPaperPlane, FaTrash, FaCheck, FaUndoAlt, FaTrashAlt } from "react-icons/fa";
    ...
    return (
        <div>
            ...
            <form id="prompt" onSubmit={addEvent}>
                ...
                <div id="buttons">
                    <button className="button" id="add" type="submit"><FaPaperPlane /></button>
                    <button className="button" id="delall" type="button" onClick={() => { delAll() }}><FaTrashAlt /></button>
                </div>
            </form>
